...
pdf_buffer = BytesIO(pdf.output(dest='S').encode())
pdf_buffer.seek(0)
...
def create_pdf():
    ...
    pdf.cell(200, 10, txt="Hello Streamlit User!", ln=True, align="C")
    pdf.cell(200, 10, txt="This is a PDF generated by fpdf.", ln=True, align="C")
    
    # This single line gets the string output and encodes it directly to bytes
    pdf_bytes = pdf.output(dest='S').encode('utf-8')
    
    # We return the bytes directly
    return pdf_bytes
pdf = creat_pdf()
